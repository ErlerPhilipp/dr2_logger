...
I assume that using all gears equally is optimal. However, the first and top gears are a bit special and shifting takes a bit of time where the engine can't accelerate the car. So, there might be situations where less shifting and even skipping a gear might be better than tightly packed gears. 

I further assume that there is an optimal RPM point where the engine can output the most power. This RPM point is specific to every car and can change with the gear setup.
...
TLDR:
- Springs
    - Set as soft as possible.
    - Set stronger when the car bottoms out or steers too slowly.
- Height
...
- Dampers
    - Set as soft as possible.
    - Set stronger when the car swings too much or bottoms out.
